function [X_t, P_t, P_bar, maha_dis, re_maha_dis] = ekf_estimation(X_tm1, P_tm1, u_t, Z_t)
...
[X_bar, P_bar] = motion_model(X_tm1, P_tm1, u_t); % prediction

% Data association
[V, PV, C_tensor, maha_dis, re_maha_dis] = data_associate(X_bar, P_bar, Z_t, Q_gamma, d_Maha_threshold);
